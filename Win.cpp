...
void Win::render(SDL_Renderer *& gRenderer)
{
		gSpriteSheetTexture.renderClip( gRenderer, 0, 0, &gSpriteClips[ 0 ]);
}
int Win::get_xpos(){
	return xpos;
}
...
bool Win::loadMedia(SDL_Renderer *& gRenderer)
{
	//Loading success flag
	bool success = true;

	//Load sprite sheet texture
	if( !gSpriteSheetTexture.loadFromFile( "./win.png" , gRenderer) )
	{
...
gSpriteClips[ 0 ].x = 0;
gSpriteClips[ 0 ].y = 0;
gSpriteClips[ 0 ].w = 504;
gSpriteClips[ 0 ].h = 684;
